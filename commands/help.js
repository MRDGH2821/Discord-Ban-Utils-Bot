...
const helpEmbed = new MessageEmbed()
	...
	.addFields(
		...
		{ name: '/import_ban_list', value: 'Imports the ban list from pastebin link' },
		{ name: '/export_ban_list', value: 'Exports the Ban list to pastebin' },
		{ name: '/transfer_bans', value: 'Exports the ban list from current server & imports it into target server without extra steps.' },
		{ name: '/kick', value: 'Kicks the given user.' },
		{ name: '/ping', value: 'Bot Latency.' },
		{ name: '/user_info', value: 'Tells if you have the permissions to kick or ban .' },
